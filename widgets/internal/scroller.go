...
// A lot of the scroll functionality was taken straight from the 2.5.2 fyne implementation

type ScrollAwareContainer interface {
	ScrollLayout(viewPort fyne.Size, size fyne.Size, offset fyne.Position)
}
